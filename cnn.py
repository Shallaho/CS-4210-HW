...
# FILENAME: cnn
# SPECIFICATION: developing a cnn model to accurately label drawn numbers
...
train_path = os.path.join(r"C:\Users\shall\PycharmProjects\CS 4210\Assignment 4\digit_dataset", "train")
test_path = os.path.join(r"C:\Users\shall\PycharmProjects\CS 4210\Assignment 4\digit_dataset", "test")

# Loading the raw images using the provided function. Hint: Use the provided load_digit_images_from_folder function
# that outputs X_train, Y_train for train_path and as X_test, Y_test for test_path --> add your Python code here
X_train, Y_train = load_digit_images_from_folder(train_path)
X_test, Y_test = load_digit_images_from_folder(test_path)
Y_train = Y_train.astype('int32')  # or 'float32' if necessary
Y_test = Y_test.astype('int32')    # or 'float32' if necessary
